  ...
  methods: {
    async getUserList() {
      ...
      const { data: res } = await this.$http.get('users', {
        //get请求会返回一个promise对象，为了简化promise操作我们用async和await优化这次异步操作
    ...
    async setRole(userInfo) {
      // 拿到userInfo把他保存到上面的data身上
      this.userInfo = userInfo
      // 在展示分配角色对话框之前，获取所有角色的列表
